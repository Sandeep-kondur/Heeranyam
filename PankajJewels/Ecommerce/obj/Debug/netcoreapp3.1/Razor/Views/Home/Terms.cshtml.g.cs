#pragma checksum "C:\Users\User\Downloads\Heeranyam\PankajJewels\Ecommerce\Views\Home\Terms.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f931272f1ade49fc1182f42f33af9bb923a4f145"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f931272f1ade49fc1182f42f33af9bb923a4f145", @"/Views/Home/Terms.cshtml")]
    ...
    public class Views_Home_Terms : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "C:\Users\User\Downloads\Heeranyam\PankajJewels\Ecommerce\Views\Home\Terms.cshtml"
...
<section class=""about-us section-padding"">
    <div class=""container"">
        ...
        <p>Heeranyam Jewellery Online Store hereby declares that we take the privacy matters of the customers very seriously. We request you to read this Privacy st");
            WriteLiteral(@"atement very carefully as it contains vital information about the things you should expect when we collect your personal information. We appreciate all your concerns, including how we will use your personal data and the steps that we take to ensure it is safe from any abuse.</p>
  ...
  ");
            WriteLiteral(@"      <p>At Heeranyam Jewellery Online Store, our primary purpose is to collect individual information. This aims at providing you with a benign, flawless, well-organized, larger customized online experience. Your consent to use the information would mean that you agree that we may use your personal information to:</p>
        <ul>
            ...
            WriteLiteral(@""">Resolve problems</li>
        ...
        <ul>
            <li style=""list-style-type: disc; margin-left: 40px;"">Ref");
            WriteLiteral(@"ining the overall service that we provide to our customers</li>
        ...
        <p>The cookies help us to determine how frequently particular pages are visited by particular customers. It also brings us potential information as to how to determine the most popular areas of the website. Our cookies also enable us to enhance your visitor experience by storing information about the products and services that you select between visits so that we can provide");
            WriteLiteral(@" you with focused information each time you visit our website.</p>
        ...
        <p>Heeranyam Jewellery Online Store guarantees you that we will use your secluded information only for the purposes stated in this Privacy Policy. We will not rent or sell your personal information to unauthorized third parties. Additionally, we will avoid y");
            WriteLiteral(@"our email address from being recorded by web robots to the best of our ability. If you have found that your email address has been chronicled in this way, please let us know immediately.</p>
        ...
        <p>Heeranyam Jewellery Online Store is not responsible for other websites which you are redirected to from our page. We are solely responsible ");
            WriteLiteral(@"for our website and its privacy policy.</p>
        ...
        <h4>11. Disclaimer</h4>
        <p>Though we put take all possible efforts to safeguard the customer data and information using our website or mobile application, we deny all accountability for any kind of liabilities for error, omission, and any inadequacies of information contained.  Website data are subject");
            WriteLiteral(@" to change as per the standard procedure we are not liable for any notification for such changes made on our website/Mobile App.</p>
